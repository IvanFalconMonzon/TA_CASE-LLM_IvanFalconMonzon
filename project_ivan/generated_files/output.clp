...
(deffacts initial-facts
  (attribute (id attr1) (class-name Nombre) (name alumnoList) (visibility private) (type "HashSet<Alumno>"))
  (class (name Nombre) (attributes attr1) (operations ))
  (attribute (id attr2) (class-name Alumno) (name 2) (visibility public) (type "string"))
  (attribute (id attr3) (class-name Alumno) (name nombreList) (visibility private) (type "HashSet<Nombre>"))
  (class (name Alumno) (attributes attr2 attr3) (operations ))
  (directedAssociation (source Nombre) (target Alumno) (multiplicity1 1) (multiplicity2 1))
)
